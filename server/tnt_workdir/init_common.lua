...
function init()
    if not box.space.banks then
        ...
        log.info('created space: banks')
    else
        log.info('space already exists: banks')
    end
    ...
    if not box.space.towns then
        ...
        log.info('created space: towns')
    else
        log.info('space already exists: towns')
    end
    ...
    if not box.space.regions then
        ...
        log.info('created space: regions')
    else
        log.info('space already exists: regions')
    end
    ...
    if not box.space.cashpoints then
        ...
        log.info('created space: cashpoints')
    else
        log.info('space already exists: cashpoints')
    end
    ...
    if not box.space.cashpoints_patches then
        ...
        log.info('space already exists: cashpoints_patches')
    end
    ...
    if not box.space.cashpoints_patches_votes then
        ...
        log.info('space already exists: cashpoints_patches_votes')
    end
    ...
    if not box.space.clusters then
        ...
        log.info('created space: clusters')
    else
        log.info('space already exists: clusters')
    end
    ...
    if not box.space.clusters_cache then
        ...
        log.info('created space: clusters_cache')
    else
        log.info('space already exists: clusters_cache')
    end
    ...
    if not box.space.metro then
        ...
        log.info('created space: metro')
    else
        log.info('space already exists: metro')
    end
